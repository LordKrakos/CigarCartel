...
## Description
Cigar Cartel is a web application that provides users with a convenient way to locate cigar cartel stores in their area.
...
- Interactive map with store markers and info windows
